...
class Screen:
    ...
    # waits
    def wait_visible(self, locator, timeout=50):
        i = 0
        while i != timeout:
            try:
    ...
    # gestures
    def swipe_to_element(self, scrollable_element_locator, direction, duration=None): # removed target_element_locator from the parameters
